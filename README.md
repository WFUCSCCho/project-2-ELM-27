...
BST vs. AVL Tree sorted running time (insertion):

![img.png](img.png)

BST vs. AVL Tree sorted running time (search):

![img_1.png](img_1.png)

BST vs. AVL Tree unsorted running rate (insertion):

![img_2.png](img_2.png)

BST vs. AVL Tree unsorted running rate (search):
